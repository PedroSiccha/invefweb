...
class RecursohumanosController extends Controller
{
    /**
    ...
    public function pagopersonal()
    {
        ...
        return view('rrhh.pagopersonal', compact('empleado', 'usuario', 'notificacion', 'cantNotificaciones'));
    }
    ...
    public function rendimientopersonal()
    {
        ...
        $empleado = \DB::SELECT('SELECT e.id AS empleado_id, e.nombre, e.apellido, e.dni, e.estado, e.valoracion, e.foto FROM empleado e');

        return view('rrhh.rendimientopersonal', compact('empleado', 'usuario', 'notificacion', 'cantNotificaciones'));
    }
    ...
    public function seguridad()
    {
        ...
        return view('rrhh.seguridad', compact('roles', 'menuRols', 'usuario', 'menus', 'permisos', 'notificacion', 'cantNotificaciones'));
    }
