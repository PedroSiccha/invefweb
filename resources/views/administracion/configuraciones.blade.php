...
@section('script')
    <script>
        ...
        function editarInteres(id, porcentaje) {
            $('#eInteres').modal('show');
        ...
        function guardarInteres() {
            ...
            $.post( "{{ Route('guardarInteres') }}", {interes: interes, dias: dias, _token:'{{csrf_token()}}'}).done(function(data) {
                $('#nInteres').modal('hide');
                setTimeout(function() {
                    toastr.options = {
                        closeButton: true,
        ...
        function guardarEInteres() {
            ...
            $.post( "{{ Route('editarInteres') }}", {id: id, interes: interes, _token:'{{csrf_token()}}'}).done(function(data) {
                $('#eInteres').modal('hide');
                setTimeout(function() {
                    toastr.options = {
                        closeButton: true,
