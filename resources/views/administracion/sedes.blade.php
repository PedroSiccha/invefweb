...
@section('script')
    <script>
        ...
        function guardarSede() {
            ...
            $.post( "{{ Route('guardarSede') }}", {nombre: nombre, detalle: detalle, telefono: telefono, telfReferencia: telfReferencia, direccion: direccion, distrito_id: distrito_id, referencia: referencia, _token:'{{csrf_token()}}'}).done(function(data) {
                $('#nSede').modal('hide');
                setTimeout(function() {
                    toastr.options = {
                        closeButton: true,
                    ...
                    toastr.success(data.inte, 'Sede Registrada');
