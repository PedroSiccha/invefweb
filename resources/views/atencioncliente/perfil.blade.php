    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            ...
            <div class="col-lg-12">
                ...
                ?>
                <button class="btn btn-success " type="button" onclick="nuevoPrestamo()" {{ $ver }}><i class="fa fa-external-link-square"></i>&nbsp;&nbsp;<span class="bold">Realizar Prestamo</span></button>
                <button class="btn btn-default " type="button" onclick="historialPrestamos()"><i class="fa fa-file-text"></i>&nbsp;&nbsp;<span class="bold">Historial Prestamo</span></button>
            </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-{{ $estado }}">
                    ...
                    <div class="panel-body row">
                        ...
                        <div class="col-lg-6">
                            <img alt="image" src="{{asset('img/codigoYape.png')}}" height="80%" width="80%">
                        </div>
                        <div class="col-lg-12">
                            <h4>Pagos en:</h4> 
                    ...
                    <div class="panel-footer">
                        <div class="btn-group">
                            <button class="btn btn-primary btn-xs" {{ $verBoton }} onclick="Pagar('{{ $pr->prestamo_id }}', '{{ $pr->monto }}', '{{ $pro->interesActual($dias, $pr->monto, $pr->porcentaje, $pr->morapagar)[0] }}', '{{ $pro->interesActual($dias, $pr->monto, $pr->porcentaje, $pr->morapagar)[1] }}', '{{ $pro->interesActual($dias, $pr->monto, $pr->porcentaje, $pr->morapagar)[2] }}', '{{ $pro->interesActual($dias, $pr->monto, $pr->porcentaje, $pr->morapagar)[4] }}', '{{ $pro->cambiaf_a_espanol($pr->fecfin) }}')"><i class="fa fa-dollar"></i> Pagar</button>
...
@section('script')
    ...
    <script>
        ...
        function verNotificacion(id) {
            ...
            $.post( "{{ Route('verNotificacion') }}", {id: id, _token:'{{csrf_token()}}'}).done(function(data) {
                $("#verNotifi").empty();
