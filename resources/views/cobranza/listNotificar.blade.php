    ...
    <tbody>
        ...
        ?>
            <tr  class="{{ $color }}" >
                ...
                <td>{{ $ln->dia }}</td>
                <td>{{ $ln->monto }}</td>
                <td>{{ $pro->interesActual($ln->dia,  $ln->monto, $ln->porcentaje, $ln->mora)[0] }}</td>
                <td>{{ $pro->interesActual($ln->dia,  $ln->monto, $ln->porcentaje, $ln->mora)[1] }}</td>
                <td>{{ $pro->interesActual($ln->dia,  $ln->monto, $ln->porcentaje, $ln->mora)[2] }}</td>
