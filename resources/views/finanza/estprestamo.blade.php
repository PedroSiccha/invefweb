...
<script>
    ...
    function graficoAnual() {
        ...
        /*
            ...
            var cantbienes = datos.cantbienes;
            var cantcliente = datos.cantcliente;
            var cantliquidacion = datos.cantliquidacion;
            var cantprestamo = datos.cantprestamo;
            var cantvendido = datos.cantvendido;
            var monmora = datos.monmora;
            var montefectivo = datos.montefectivo;
            var montinteres = datos.montinteres;
            var monventa = datos.monventa;
            ...
            for(i=0; i<totalanios; i++){
                anio.push( numanio[i] );
                Prestamos.push( cantprestamo[i] );
                Bienes.push( cantbienes[i] );
                Liquidacion.push( cantliquidacion[i] );
                Vendidos.push( cantvendido[i] );
                Clientes.push( cantcliente[i] );
                Efectivo.push( montefectivo[i] );
                Interes.push( montinteres[i] );
                Mora.push( monmora[i] );
                Venta.push( monventa[i] );
                Gastos.push( gastoadmin[i] );
                presActivo.push( prestamoActivo[i] );
            ...
            new Chart(document.getElementById("canBienesAnioChart"), {
                ...
                data: {
                    ...
                    datasets: [{ 
                        data: Bienes, //Cantidad de Prestamos
                ...
                options: {
                    title: {
                    display: true,
                    text: 'Balance Anual de Bienes'
                    }
                }
            });

            new Chart(document.getElementById("canLiquidacionAnioChart"), {
                type: 'bar',
                data: {
                    labels: anio, //Cargar dias
                    datasets: [{ 
                        data: Liquidacion, //Cantidad de Prestamos
                ...
                options: {
                    title: {
                    display: true,
                    text: 'Balance Anual de Liquidación'
                    }
                }
            });

            new Chart(document.getElementById("canVendidoAnioChart"), {
                type: 'bar',
                data: {
                    labels: anio, //Cargar dias
                    datasets: [{ 
                        data: Vendidos, //Cantidad de Prestamos
                ...
                options: {
                    title: {
                    display: true,
                    text: 'Balance Anual de Vendidos'
                    }
                }
            });

            new Chart(document.getElementById("canClienteAnioChart"), {
                type: 'bar',
                data: {
                    labels: anio, //Cargar dias
                    datasets: [{ 
                        data: Clientes, //Cantidad de Prestamos
                ...
                options: {
                    title: {
                    display: true,
                    text: 'Balance Anual de Clientes'
                    }
                }
            });
            ...
            new Chart(document.getElementById("canpActivosAnioChart"), {
                ...
                data: {
                    ...
                    datasets: [
                        { 
                            data: presActivo, //Cantidad de Prestamos
                            label: "Prestamos Nuevos",
                            borderColor: "#3e95cd"
                        },
                        {
                            data: renActivo, //Cantidad de Prestamos
                            label: "Renovaciones",
                            borderColor: "#C72200"
                        }
                    ]
