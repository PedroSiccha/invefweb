...
<div>
    ...
    <div class="page">
            ...
            <br>
            <br>
            <h1 class="titulo" style="text-decoration: underline;">CONTRATO DE PRESTAMO CON GARANTIA PRENDARIA N° {{ $co->prestamo_id }}</h1>
            <h1 class="textos">
             ...
             <h1 class="textos">
                <b style="text-decoration: underline;">CLAUSULA PRIMERA:</b> <b>LA EMPRESA INVERSIONES “INVEF” S.A.C</b>, cede en calidad de préstamo al <b>PRESTATARIO</b>, la suma total de <b>S/. {{ $co->monto }}</b> (<?php echo valorEnLetras( $co->monto ); ?> 
                CON 00/100 NUEVOS SOLES), <?php  $arrayMeses = array('Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre');
