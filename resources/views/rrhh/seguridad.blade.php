                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-warning" onclick="mostrarPermisosRoles('{{ $ro->id }}', '{{ $ro->nombre }}')"><i class="fa fa-id-badge"></i></button>
                                                </td>
                                            </tr>            
                                            @endforeach
                                        </tbody>
        ...
        <div class="col-sm-12">
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <span class="float-right small text-muted">0 Productos</span>
                    <ul class="nav nav-tabs">
                        <li><a class="nav-link active" data-toggle="tab" href="#tab-1" onclick="nuevoPermiso()"><i class="fa fa-plus"></i></a></li>
                    </ul>
                    <div class="tab-content" id="tabPermisos">
                        <div id="tab-1" class="tab-pane active">
                            <div class="full-height-scroll">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
