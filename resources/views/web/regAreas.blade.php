    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Configuracion de las Áreas</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>Resumen Área</h5>
                    <div class="ibox-tools">
                        <button type="button" class="btn btn-w-m btn-default btn-xs" onclick="mostrarArea()"> <i class="fa fa-plus"></i></button>
                        <a class="close-link">
                            <i class="fa fa-times"></i>
                        </a>
                    </div>
                </div>
                <div class="ibox-content" id="tblArea">
...
<div class="modal inmodal fade" id="banner" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="fbanner" name="fbanner" method="post" action="guardarBannerArea" class="formBanner" enctype="multipart/form-data">
...
<div class="modal inmodal fade" id="ebanner" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="febanner" name="febanner" method="post" action="editarBannerArea" class="formeBanner" enctype="multipart/form-data">
            <div class="modal-body">
...
<!-- Area -->
<!-- Crear -->
<div class="modal inmodal fade" id="resumenArea" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            ...
            <form id="farea" name="farea" method="post" action="guardarArea" class="formArea" enctype="multipart/form-data">
            <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" placeholder="Ingresar Área" class="form-control" id="area" name="area" required>
                            </div>
                        </div>
                        <div class="col-md-12 row">
                            <label class="col-sm-4 col-form-label">Resumen</label>
                            <div class="col-sm-12">
                                <input type="text" placeholder="Ingresar Resumen" class="form-control" id="resumen" name="resumen" required>
                            </div>
                        </div>
                        <div class="col-md-12 row">
                            <label class="col-sm-4 col-form-label">Descripción</label>
                            <div class="col-sm-12">
                                <textarea class="form-control" placeholder="Ingrese la descripción" rows="3" id = "descripcion" name = "descripcion" required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" placeholder="Ingresar link de facebook" class="form-control" id="facebook" name="facebook" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" placeholder="Ingresar link de twitter" class="form-control" id="twitter" name="twitter" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" placeholder="Ingresar Correo" class="form-control" id="correo" name="correo" required>
                            </div>
                        </div>

                        <div class="col-md-12 row">
                            <label class="col-sm-4 col-form-label">Número de Celular</label>
                            <div class="col-sm-12">
                                <input type="number" placeholder="Ingresar Numero de Celular" class="form-control" id="celular" name="celular" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="col-sm-12">
                                <input type="number" placeholder="Ingresar Numero de Whatsapp" class="form-control" id="whatsapp" name="whatsapp" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" placeholder="Ingresar el canal de youtube" class="form-control" id="youtube" name="youtube" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="col-sm-12">
                                <input type="text" placeholder="Ingresar Instagram" class="form-control" id="instagram" name="instagram" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="custom-file col-sm-12">
                                <input id="foto" type="file" class="custom-file-input" id="idFoto" name="foto">
                                <label for="foto" class="custom-file-label" id="lFoto">Seleccionar...</label>
                            </div>
                        </div>
