	  		...
	  		<div class="row">
				...
				<div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
				    <div class="plan text-center">
				        <span class="plan-name"><h5>{{ $s->titulo }}</h5> <small>{{ $s->resumen }}</small></span>
				        <p class="plan-price"><img src="{{ $s->imagen }}" alt =""/></p>
				        ...
				        <a class="btn btn-primary" onclick="verRquisitos('{{ $s->id }}')">REQUISITOS</a>
				    </div>
				</div><!-- plan end -->
				@endforeach
			</div><!--/ Content row end -->
